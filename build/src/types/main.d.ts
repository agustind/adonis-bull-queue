...
export type AllowedJobTypes = JobHandlerConstructor | (() => Promise<{
...
export type InferJobPayload<T extends JobHandlerConstructor> = Parameters<InstanceType<T>['handle']>[0];
